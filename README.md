...
Це базовий курс з вивчення мови програмування **Rust**.

Тут зібрані мої навчальні проєкти, приклади та нотатки з основних тем:

* Синтаксис і основи Rust
* Змінні, типи даних, функції
* Керування пам’яттю: володіння, запозичення, посилання
* Керуючі конструкції та робота з модулями
* Робота з `Cargo` та структура проєкту

## 📦 Мета репозиторію

Систематизувати процес вивчення Rust і зібрати практичні приклади, які допоможуть краще зрозуміти мову.

## 📁 Структура

Кожна папка — це окремий урок або тема з вихідним кодом.
